...
const WHEELS_PAINT_TITLE = "ОКРАС ДИСКОВ И СУППОРТОВ";
const DENT_REMOVAL_TITLE = "УДАЛЕНИЕ ВМЯТИН";
const STEERING_WHEEL_REWRAP_TITLE = "ПЕРЕШИВ РУЛЯ";
const INTERIOR_RESTORATION_TITLE = "РЕСТАВРАЦИЯ САЛОНА";
const SEAT_REPAIR_TITLE = "РЕМОНТ СИДЕНИЙ АВТОМОБИЛЯ";
...
const PRICING_DATA = {
  ...
  WHEELS_PAINT_GROUPS: [
    ...
    { title: "ОКРАС СУППОРТОВ (4 шт)", items: ["Окрашивание суппортов", "Окрашивание суппортов с логотипом"] },
  ...
  PRICES: {
    ...
    "Окрашивание суппортов с логотипом": [84700, 84700, 84700, 84700, 84700],
